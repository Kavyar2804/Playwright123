...
import { readdatafromexcel } from '../../genricutility/excelutility';
...
let path = 'C:/Users/User/OneDrive/Desktop/pw_batch123/testdata/excel.xlsx'
...
test('write data', async({page}) => {
   ...
   await book.xlsx.writeFile('C:/Users/User/OneDrive/Desktop/pw_batch123/testdata/excel.xlsx')
